 ...
 */
package org.training.fulfilmentprocess.test.jobs;
...
import org.training.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TrainingFulfilmentProcessConstants.ORDER_PROCESS_NAME;
