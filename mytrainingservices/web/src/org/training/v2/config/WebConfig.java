 ...
 */
package org.training.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import org.training.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mytrainingservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mytrainingservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mytrainingservices.oauth2.tokenUrl";

	private static final String DESC = "mytrainingservices.v2.description";
	private static final String TITLE = "mytrainingservices.v2.title";
	private static final String VERSION = "mytrainingservices.v2.version";
