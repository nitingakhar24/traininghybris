...
import org.training.swagger.ApiBaseSiteIdAndUserIdAndPaymentDetailsParams;
...
public class PaymentDetailsController extends BaseCommerceController
{
	...
	@ApiBaseSiteIdAndUserIdAndPaymentDetailsParams
	@ResponseStatus(HttpStatus.OK)
	public void replacePaymentDetails(@PathVariable final String paymentDetailsId, final HttpServletRequest request)
			throws RequestParameterException //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
